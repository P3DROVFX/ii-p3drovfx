...
ContentPage {
    ...
    RowLayout {
        ...
        StyledText {
            text: Translation.tr("Weather Pill 1x0.5 Options")
    ...
    ContentSection {
        ...
        Item {
            ...
            PagePlaceholder {
                ...
                title: Translation.tr("Weather Pill widget disabled")
                description: Translation.tr("Enable the Weather Pill 1x0.5 widget in Desktop Widgets settings to use this page.")
            }
        }
        ...
        ColumnLayout {
            ...
            ColumnLayout {
                ...
                ConfigSwitch {
                    ...
                    checked: Config.options.background.widgets.weather_pill.expressiveColors ?? false
                    onCheckedChanged: {
                        Config.options.background.widgets.weather_pill.expressiveColors = checked;
                    }
                }
