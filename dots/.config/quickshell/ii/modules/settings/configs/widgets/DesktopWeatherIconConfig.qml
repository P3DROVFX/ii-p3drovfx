...
ContentPage {
    ...
    RowLayout {
        ...
        StyledText {
            text: Translation.tr("Weather Icon Options")
    ...
    ContentSection {
        ...
        Item {
            ...
            PagePlaceholder {
                ...
                title: Translation.tr("Weather Icon widget disabled")
                description: Translation.tr("Enable the Weather Icon Shape widget in Desktop Widgets settings to use this page.")
            }
        }
        ...
        ColumnLayout {
            ...
            ColumnLayout {
                ...
                ConfigSwitch {
                    ...
                    checked: Config.options.background.widgets.weather_icon.expressiveColors ?? false
                    onCheckedChanged: {
                        Config.options.background.widgets.weather_icon.expressiveColors = checked;
                    }
                }
