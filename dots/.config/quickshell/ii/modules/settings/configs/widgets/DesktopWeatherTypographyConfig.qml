...
ContentPage {
    ...
    RowLayout {
        ...
        StyledText {
            text: Translation.tr("Weather Typography Options")
    ...
    ContentSection {
        ...
        Item {
            ...
            PagePlaceholder {
                ...
                title: Translation.tr("Weather Typography widget disabled")
                description: Translation.tr("Enable the Weather Typography widget in Desktop Widgets settings to use this page.")
            }
        }
        ...
        ColumnLayout {
            ...
            ColumnLayout {
                ...
                ConfigSwitch {
                    ...
                    checked: Config.options.background.widgets.weather_typography.expressiveColors ?? false
                    onCheckedChanged: {
                        Config.options.background.widgets.weather_typography.expressiveColors = checked;
                    }
                }
