...
ContentPage {
    ...
    RowLayout {
        ...
        StyledText {
            text: Translation.tr("Forecast Weather 2x1 Options")
    ...
    ContentSection {
        ...
        Item {
            ...
            implicitHeight: 250
            visible: !Config.isWidgetActive("weather_forecast")

            PagePlaceholder {
                anchors.fill: parent
                icon: "cloud_off"
                shape: MaterialShape.Shape.Circle
                title: Translation.tr("Forecast Weather widget disabled")
                description: Translation.tr("Enable the Forecast Weather 2x1 widget in Desktop Widgets settings to use this page.")
            }
        }
        ...
        ColumnLayout {
            ...
            ColumnLayout {
                ...
                ConfigSwitch {
                    ...
                    checked: Config.options.background.widgets.weather_forecast.expressiveColors ?? false
                    onCheckedChanged: {
                        Config.options.background.widgets.weather_forecast.expressiveColors = checked;
                    }
                }
