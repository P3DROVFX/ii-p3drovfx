    ...
    ContentPage {
        ...
        ContentSection {
            ...
            ColumnLayout {
                ...
                ConfigSwitch { buttonIcon: "mobile_share"; text: Translation.tr("Send files to phone"); description: Translation.tr("Adds KDE Connect and LocalSend actions (Ctrl+K) to file results when a device is available."); checked: Config.options.search.modules.phoneShare.enable; onCheckedChanged: Config.options.search.modules.phoneShare.enable = checked }
