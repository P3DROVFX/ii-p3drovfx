        ...
        ColumnLayout {
            ...
            ColumnLayout {
                ...
                ConfigSwitch {
                    ...
                    checked: Config.options.background.widgets.weather_circle.expressiveColors ?? false
                    onCheckedChanged: {
                        Config.options.background.widgets.weather_circle.expressiveColors = checked;
                    }
                }
