...
AbstractBackgroundWidget {
    ...
    readonly property var options: Config.options.background.widgets.resource_ram_pill
        ...
        Item {
            ...
            Rectangle {
                ...
                Rectangle {
                    ...
                    width: Math.max(0, parent.width * Math.min(1.0, Math.max(0.0, root.ramUsagePct)))
