...
AbstractBackgroundWidget {
    ...
    readonly property real contentScale: (Config.options.background.widgets.triple_ring_clock.widgetSize ?? 100) / 100.0
    ...
    readonly property bool cfgUseBlackBg:
        Config.ready ? (Config.options.background.widgets.triple_ring_clock.useBlackBg ?? true) : true
    readonly property bool cfgEnableGlassReflection:
        Config.ready ? (Config.options.background.widgets.triple_ring_clock.enableGlassReflection ?? false) : false
    readonly property bool cfgBoldFont:
        Config.ready ? (Config.options.background.widgets.triple_ring_clock.boldFont ?? true) : true
    ...
    Item {
        ...
        // 1. MaterialShape Circle Outer Background
        MaterialShape {
            id: clockBgShape
            anchors.fill: parent
