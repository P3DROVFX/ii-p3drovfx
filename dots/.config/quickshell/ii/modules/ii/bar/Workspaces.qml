...
Item {
    ...
    Item {
        ...
        Loader {
            ...
            opacity: root.workspaceIndexInGroup < 0 || root.scratchpadOpen ? 0.0 : 1.0
            Behavior on opacity {
                NumberAnimation {
        ...
        // Position reference for the scratchpad overlay (maps from container coords to root coords)
        Item {
    ...
    // Scratchpad indicator overlay (unblurred, positioned at the active slot)
    Item {
