...
Singleton {
    ...
    function getLayerRulesScript(): string {
        ...
        // The drop shelf and the wallpaper drop overlay must never frost the
        // wallpaper behind them, whatever the preset's ignore_alpha is.
        ...
        script += "hl.layer_rule({ match = { namespace = 'quickshell:dropshelf' }, blur = false, blur_popups = false, ignore_alpha = 1.0 }) ";
