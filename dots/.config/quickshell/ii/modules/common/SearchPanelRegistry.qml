...
Singleton {
    ...
    readonly property var panels: [
        ...
        { id: "speedTest", source: "SpeedTestPanel.qml", prefixKey: "speedTest", keywords: ["speed", "speedtest", "internet", "velocidade", "bandwidth", "download", "upload", "ping", "fast", "rede", "conexao", "conexão", "teste de velocidade", "network velocity", "network", "velocity"], label: qsTr("Speed Test"), icon: "speed", searchIcon: "speed", searchShape: "Pentagon", searchRotationStep: 72, width: () => Config.options.search.appearance.panelWidth, enabled: () => Config.options.search.modules.speedTest?.enable ?? true, accent: true, focusMode: "input", queryProperty: "", inputOwner: "panel", hosted: true },
        ...
        { id: "gifs", source: "GifsPanel.qml", prefixKey: "", keywords: ["gif", "gifs", "klipy", "meme", "memes", "reaction", "reação"], label: qsTr("GIFs"), icon: "gif_box", searchIcon: "gif_box", searchShape: "Cookie6Sided", searchRotationStep: 60, width: () => Config.options.search.appearance.panelWidth, enabled: () => Config.options.search.modules.gifs?.enable ?? true, accent: true, focusMode: "grid", queryProperty: "searchQuery", hosted: true },
        { id: "grammar", source: "GrammarPanel.qml", prefixKey: "", keywords: ["grammar", "spelling", "spell check", "proofread", "fix grammar", "gramática", "gramatica", "ortografia", "corrigir", "revisar texto"], label: qsTr("Fix grammar"), icon: "spellcheck", searchIcon: "spellcheck", searchShape: "Pentagon", searchRotationStep: 72, width: () => Config.options.search.appearance.panelWidth, enabled: () => (Config.options.search.modules.grammar?.enable ?? true) && Ai.enabled, accent: true, focusMode: "list", queryProperty: "searchQuery", hosted: true },
        { id: "fonts", source: "FontsPanel.qml", prefixKey: "", keywords: ["font", "fonts", "fonte", "fontes", "typeface", "typography", "tipografia"], label: qsTr("Fonts"), icon: "text_fields", searchIcon: "text_fields", searchShape: "Arch", searchRotationStep: 360, width: () => Config.options.search.appearance.panelWidth, enabled: () => Config.options.search.modules.fonts?.enable ?? true, accent: true, focusMode: "list", queryProperty: "searchQuery", hosted: true }
    ]
